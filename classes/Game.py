...
class Game:
    def __init__(self, path: list[RushHourPuzzle], puzzle: RushHourPuzzle) -> None:
        self.path = path
        self.puzzle = puzzle
    ...
    def run(self):
        ...
        board_width = self.puzzle.board_width
        board_height = self.puzzle.board_height
